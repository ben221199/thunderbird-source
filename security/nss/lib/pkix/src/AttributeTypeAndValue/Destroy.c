...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/AttributeTypeAndValue/Attic/Destroy.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:13:14 $ $Name:  $";
#endif /* DEBUG */
