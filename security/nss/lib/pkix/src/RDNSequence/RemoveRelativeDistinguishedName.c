...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/RDNSequence/Attic/RemoveRelativeDistinguishedName.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:14:16 $ $Name:  $";
#endif /* DEBUG */
