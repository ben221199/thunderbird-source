...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/RelativeDistinguishedName/Attic/Encode.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:14:22 $ $Name:  $";
#endif /* DEBUG */
