...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/RelativeDistinguishedName/Attic/PEqual.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:14:25 $ $Name:  $";
#endif /* DEBUG */
