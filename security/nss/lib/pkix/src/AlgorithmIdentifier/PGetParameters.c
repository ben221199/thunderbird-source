...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/AlgorithmIdentifier/Attic/PGetParameters.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:07:40 $ $Name:  $";
#endif /* DEBUG */
