...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/AlgorithmIdentifier/Attic/PDuplicate.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:06:57 $ $Name:  $";
#endif /* DEBUG */
