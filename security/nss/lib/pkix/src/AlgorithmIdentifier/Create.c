...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/AlgorithmIdentifier/Attic/Create.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:04:58 $ $Name:  $";
#endif /* DEBUG */
