...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/AlgorithmIdentifier/Attic/SetParameters.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:08:55 $ $Name:  $";
#endif /* DEBUG */
