...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/Attribute/Attic/verifyPointer.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:12:56 $ $Name:  $";
#endif /* DEBUG */
