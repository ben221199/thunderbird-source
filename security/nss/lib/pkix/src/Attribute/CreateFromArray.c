...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/Attribute/Attic/CreateFromArray.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:09:07 $ $Name:  $";
#endif /* DEBUG */
