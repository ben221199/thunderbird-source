...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/Attribute/Attic/GetValueCount.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:09:57 $ $Name:  $";
#endif /* DEBUG */
